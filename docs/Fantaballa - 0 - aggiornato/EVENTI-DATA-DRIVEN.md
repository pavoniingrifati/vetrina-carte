...
- `data/events/events-common.json`: 71 decisioni e 4 eventi automatici condivisi.
...
- `assets/season/08b-user-events.js`: logica persistente dei nuovi eventi utente e delle conseguenze nelle partite successive.
