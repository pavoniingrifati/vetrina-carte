...
(function(){
 ...
 showSetup=function(){
  ...
  screen.innerHTML=`<div class="season-setup-flow weekly-pisa-setup">
   <section class="panel season-weekly-intro"><div class="season-setup-kicker">Evento del weekend</div><h2>Tricolore col Pisa!</h2><p>La squadra è bloccata sul Pisa. Scegli modalità degli eventi, allenatore e modulo; nel draft troverai immediatamente l’intera rosa nerazzurra.</p><div class="season-weekly-reward"><b>🏁 Sfida della settimana</b><span>${esc(WEEKLY.rewardText||'I primi 10 classificati ricevono un +2 OVR al proprio giocatore.')}</span></div></section>
