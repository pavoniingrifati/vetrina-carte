...
function resolveLineup(){enforceTipsterStarters();if(typeof enforceCaptainArmbandStarter==='function')enforceCaptainArmbandStarter();if(state.seasonRules?.autoOptimizeLineup)optimizeLineupWithBench();if(typeof enforceCaptainArmbandStarter==='function')enforceCaptainArmbandStarter();enforceFrenchFlyingPositions();if(typeof enforceBadLuckPlayerLineup==='function')enforceBadLuckPlayerLineup();return applyWrongShirtSwap(resolveRosterLineup(rosterPlayers()))}
