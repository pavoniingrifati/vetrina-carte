...
function normalizeCampionatoState(input){
 ...
 next.draft.lastPlacement=next.draft.lastPlacement&&typeof next.draft.lastPlacement==='object'?next.draft.lastPlacement:null;
 if(next.draft.lastPlacement){
   next.draft.lastPlacement.playerId=String(next.draft.lastPlacement.playerId||'');
   next.draft.lastPlacement.slotId=String(next.draft.lastPlacement.slotId||'');
   next.draft.lastPlacement.clubId=String(next.draft.lastPlacement.clubId||'');
   next.draft.lastPlacement.candidates=Array.isArray(next.draft.lastPlacement.candidates)?next.draft.lastPlacement.candidates.map(String):[];
 }
