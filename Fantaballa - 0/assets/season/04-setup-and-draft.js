...
function draftCandidateOvrStyle(ovr){
 ...
 const ovrBg=tier==='diamond'?'linear-gradient(180deg,#dffcff,#81ecff)':tier==='gold'?'linear-gradient(180deg,#fff0a2,#eebc28)':tier==='purple'?'linear-gradient(180deg,#d8c3ff,#8f62d4)':tier==='blue'?'linear-gradient(180deg,#bfe9ff,#5ebdff)':(dark?'#ffe96c':'#10243a');
 const ovrText=tier==='diamond'?'#08344d':tier==='gold'?'#352100':tier==='purple'?'#27143f':tier==='blue'?'#08304a':(dark?'#10243a':'#ffffff');
 const ovrBorder=tier==='diamond'?'rgba(223,252,255,.95)':tier==='gold'?'#fff7d0':tier==='purple'?'#efe2ff':tier==='blue'?'#e5f6ff':(dark?'rgba(16,36,58,.2)':'rgba(255,255,255,.28)');
