...
function customCreatorAvatarSvg(player,sub=false){
 const key=String(player?.creatorStyle||'').trim().toLowerCase()||String(player?.name||'').trim().toLowerCase()||String(player?.id||'');
 const isFantaballa=key==='fantaballa'||String(player?.id||'')==='384';
 const isMisterFm=key==='misterfm'||String(player?.id||'')==='852';
 if(!isFantaballa&&!isMisterFm)return'';
 const rim=sub?'#ffe76a':'#d9c8a7';
 if(isFantaballa)return `<svg viewBox="0 0 84 84" aria-hidden="true" focusable="false"><defs><linearGradient id="cfbg1" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stop-color="#284c73"/><stop offset="100%" stop-color="#d8e6f2"/></linearGradient></defs><rect x="4.5" y="4.5" width="75" height="75" rx="22" fill="url(#cfbg1)"/><ellipse cx="42" cy="42" rx="23" ry="28" fill="#efbf9a"/><ellipse cx="15.2" cy="41.5" rx="4.8" ry="7.6" fill="#efbf9a"/><ellipse cx="68.8" cy="41.5" rx="4.8" ry="7.6" fill="#efbf9a"/><path d="M18.2 32.1c2.5-12.8 12.5-22 24.7-22 10.2 0 17.9 5.6 21.3 16.8-5.2-2.4-10.3-3.4-15.5-3.1-10.4.6-18.2 5.9-24.9 14.6-2.8-1-4.8-3.1-5.6-6.3z" fill="#30231d"/><path d="M25.5 26.9c11.5-5.8 23.3-6.5 35.2-.5-10-1.2-18.2.4-24.8 4.8-4.6 3.1-7.8 7.3-10.6 12.3-1.9-3.9-1.7-10 .2-16.6z" fill="#47342b" opacity=".88"/><path d="M26.6 34.5c3-1.8 6.2-2.6 9.7-2.4" fill="none" stroke="#3b2921" stroke-width="2" stroke-linecap="round"/><path d="M47 32.1c3.5-.2 6.7.6 9.7 2.4" fill="none" stroke="#3b2921" stroke-width="2" stroke-linecap="round"/><ellipse cx="33.2" cy="42.2" rx="3.7" ry="3.15" fill="#fff" stroke="rgba(90,52,31,.2)" stroke-width=".65"/><ellipse cx="50.8" cy="42.2" rx="3.7" ry="3.15" fill="#fff" stroke="rgba(90,52,31,.2)" stroke-width=".65"/><circle cx="33.2" cy="42.2" r="2" fill="#79b8dc"/><circle cx="50.8" cy="42.2" r="2" fill="#79b8dc"/><circle cx="33.2" cy="42.2" r=".8" fill="#17202a"/><circle cx="50.8" cy="42.2" r=".8" fill="#17202a"/><circle cx="32.6" cy="41.5" r=".45" fill="#fff"/><circle cx="50.2" cy="41.5" r=".45" fill="#fff"/><path d="M42 43.7c1.4 1.8 2.1 3.7 2.1 5.7 0 1.8-.8 3-2.6 3.9" fill="none" stroke="rgba(120,80,58,.55)" stroke-width="1.45" stroke-linecap="round" stroke-linejoin="round"/><path d="M34.4 58.2c2.4 1.8 4.9 2.8 7.6 2.8 2.7 0 5.2-1 7.6-2.8" fill="none" stroke="#6a3528" stroke-width="1.5" stroke-linecap="round"/><path d="M27.4 51.7c1.1 8.9 7.1 15.2 14.6 15.2s13.5-6.3 14.6-15.2c-2.6 2.5-5 3.9-7.6 4.8-2.1.7-4.3 1-7 1-2.8 0-5-.3-7.1-1-2.5-.9-4.9-2.3-7.5-4.8z" fill="#49342b" opacity=".78"/><path d="M31.7 52.3c2.5 2 5.4 2.8 8.3 2.8h4c2.9 0 5.8-.8 8.3-2.8-1.3 2.8-4.5 4.4-8.2 4.4h-4.2c-3.7 0-6.9-1.6-8.2-4.4z" fill="#30231d" opacity=".9"/><path d="M31.3 58.2c3 3.6 6.6 5.4 10.7 5.4 4.1 0 7.7-1.8 10.7-5.4" fill="none" stroke="#241a15" stroke-width="1.1" stroke-linecap="round" opacity=".78"/><circle cx="21" cy="15" r="1.4" fill="#f8f4dc" opacity=".92"/><circle cx="61" cy="14" r="1.2" fill="#f8f4dc" opacity=".92"/><path d="M63 26l1 2.5 2.5 1-2.5 1-1 2.5-1-2.5-2.5-1 2.5-1z" fill="#f8f4dc" opacity=".92"/><rect x="4.5" y="4.5" width="75" height="75" rx="22" fill="none" stroke="${rim}" stroke-width="1.4"/></svg>`;
 return `<svg viewBox="0 0 84 84" aria-hidden="true" focusable="false"><defs><linearGradient id="cfbg2" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stop-color="#25314d"/><stop offset="100%" stop-color="#6f2df6"/></linearGradient></defs><rect x="4.5" y="4.5" width="75" height="75" rx="22" fill="url(#cfbg2)"/><ellipse cx="42" cy="42" rx="23" ry="28" fill="#eeb991"/><ellipse cx="15.2" cy="41.5" rx="4.8" ry="7.6" fill="#eeb991"/><ellipse cx="68.8" cy="41.5" rx="4.8" ry="7.6" fill="#eeb991"/><path d="M20.8 27.2c5.2-8.5 12.9-12.7 21.2-12.7 8.3 0 16 4.2 21.2 12.7l-4.2 2.4c-4.4-4.9-10.1-7.4-17-7.4s-12.6 2.5-17 7.4z" fill="#f3bf45"/><path d="M24.4 28.2h35.2v5H24.4z" fill="#fffdf8" stroke="rgba(75,48,31,.18)" stroke-width=".7"/><path d="M25 26.8c4.7-5.1 10.4-7.6 17-7.6 6.6 0 12.3 2.5 17 7.6" fill="none" stroke="rgba(255,255,255,.5)" stroke-width="1.1" stroke-linecap="round"/><path d="M27.1 35.1c2.8-1.5 5.8-2.1 9.1-1.9" fill="none" stroke="#382316" stroke-width="2" stroke-linecap="round"/><path d="M47.8 33.2c3.2-.1 6.2.5 9 1.9" fill="none" stroke="#382316" stroke-width="2" stroke-linecap="round"/><g stroke="#524036" stroke-width="1.9" fill="rgba(219,234,254,.22)"><rect x="24.8" y="38.2" width="14.2" height="10" rx="3.4"/><rect x="45" y="38.2" width="14.2" height="10" rx="3.4"/><path d="M39 43h6"/></g><circle cx="33.2" cy="42.8" r="1.35" fill="#473124"/><circle cx="50.8" cy="42.8" r="1.35" fill="#473124"/><path d="M42 43.7c1.4 1.8 2.1 3.7 2.1 5.7 0 1.8-.8 3-2.6 3.9" fill="none" stroke="rgba(120,80,58,.55)" stroke-width="1.45" stroke-linecap="round" stroke-linejoin="round"/><path d="M34.8 57.8c2.1 1.8 4.5 2.7 7.2 2.7 2.7 0 5.1-.9 7.2-2.7" fill="none" stroke="#7c4330" stroke-width="1.5" stroke-linecap="round"/><path d="M29.8 52.4c2.3 1.5 4.2 2.3 12.2 2.3 8 0 9.9-.8 12.2-2.3 0 7.6-4.9 13-12.2 13-7.3 0-12.2-5.4-12.2-13z" fill="#4b301f" opacity=".72"/><path d="M31.5 55.5c3 2.2 6.4 3.3 10.5 3.3s7.5-1.1 10.5-3.3" fill="none" stroke="#2c1b12" stroke-width="1.1" stroke-linecap="round" opacity=".78"/><circle cx="21" cy="15" r="1.4" fill="#f8f4dc" opacity=".92"/><circle cx="61" cy="14" r="1.2" fill="#f8f4dc" opacity=".92"/><path d="M63 26l1 2.5 2.5 1-2.5 1-1 2.5-1-2.5-2.5-1 2.5-1z" fill="#f8f4dc" opacity=".92"/><rect x="4.5" y="4.5" width="75" height="75" rx="22" fill="none" stroke="${rim}" stroke-width="1.4"/></svg>`;
}
function renderAvatarSvg(player,sub=false){
 const customSvg=customCreatorAvatarSvg(player,sub);
