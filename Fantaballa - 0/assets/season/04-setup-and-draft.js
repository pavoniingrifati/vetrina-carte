...
function showSetup(){
 ...
 const competitionChoiceHtml=isFantacampionato?`<div class="season-mode-grid season-competition-grid"><button type="button" class="season-mode-btn ${state.competitionVariant!=='legend'?'active':''}" data-competition-variant="serie-a"><b>🇮🇹 Serie A</b><small><strong>20 club della stagione 2026/2027</strong> e 531 calciatori reali. È il Fantacampionato che hai già utilizzato.</small></button><button type="button" class="season-mode-btn ${state.competitionVariant==='legend'?'active':''}" data-competition-variant="legend"><b>🌟 Legend</b><small><strong>40 squadre storiche</strong> e 796 giocatori. Ogni run affronta 19 avversarie casuali, mentre il draft può pescare dall’intero database.</small></button></div>`:'';
