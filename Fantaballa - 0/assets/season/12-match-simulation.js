...
function playRoyalRumbleMatch(){
 ...
 save();const status=rr.completed?(rr.champion?'Hai eliminato tutte le squadre: sei campione!':'Non hai vinto la sfida: sei eliminato dal campionato.'):`Vittoria! Restano ${Math.max(0,queue.length-rr.index)} avversarie.`;
...
function postMatch(){
 ...
 state.matchday++;state.pendingEvent=null;
