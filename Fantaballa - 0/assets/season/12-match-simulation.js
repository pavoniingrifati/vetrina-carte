...
function playRound(mode='instant'){
 ...
 const finishRound=()=>{
   if(committed)return;
   const canUseRokky=coachIs('rokky')&&!fantaballopoliRule.forceNoDraw&&!rokkyDecisionShown&&!formulaOneWalkoverView&&!error404Corrupted&&!hungerWalkover&&Number(officialGoalsAgainst)>0;
