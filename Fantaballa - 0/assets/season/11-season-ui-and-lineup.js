...
function renderSeasonUpcomingFixtures(){
 ...
 return `<section class="panel season-home-card season-home-upcoming"><div class="season-home-section-head"><div><span>Calendario</span><b>Prossimi impegni</b></div><button type="button" id="openCalendarTab" class="season-home-text-button">Tutto →</button></div><div class="season-home-fixture-list">${rows||'<p class="season-home-empty">Nessun altro incontro programmato.</p>'}</div></section>`;
}
