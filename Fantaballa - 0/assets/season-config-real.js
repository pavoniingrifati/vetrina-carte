window.FANTABALLA_SEASON_CONFIG=Object.freeze({
 mode:'real',
 storage:{
  saveBase:'fantaballa_campionato_real_2026_27_v2',
  legacySaveKeys:[],
 ...
 data:{
  primaryPlayers:'data/giocatori-real.json?v=f41541ba5cbd',
  primaryClubs:'data/club-real.json?v=a81019ee5dde',
  ...
  variants:{
   ...
   champions:{id:'champions',label:'Champions League',players:'data/champions/giocatori-champions.json?v=592a35e3f4c4',clubs:'data/champions/club-champions.json?v=eda1412649ce',playerCount:970,description:'Trentasei club UEFA, quattro fasce e fase campionato da 8 giornate, seguita da playoff e tabellone a eliminazione diretta.'}
  }
 },
 validation:{
  minimumClubCount:21,
