(() => {
  ...
  const definitions = [
    ...
    { id:'mani-pulite', category:'Fantaballopoli', icon:'🧼', title:'Mani pulite', description:'Rifiuta la Triade e sconfiggi La Juve della Triade.' },
    { id:'dentro-fino-al-collo', category:'Fantaballopoli', icon:'🕳️', title:'Dentro fino al collo', description:'Entra nella Triade, ottieni Giuda e conquista tutti e tre i Cartonati.' },
