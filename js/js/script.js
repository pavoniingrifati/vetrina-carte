...
function applyChampionsWallpaper(media, club, wallpaperUrl, tileIndex) {
  ...
  media.style.setProperty('background-image', `url(${wallpaperUrl})`, 'important');
  ...
  media.style.setProperty('background-position', positions[tileIndex % positions.length], 'important');
