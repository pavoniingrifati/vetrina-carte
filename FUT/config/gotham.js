...
window.FUTTU_CONFIG = {
  ...
  cardsSources: ['data/cards.json', 'cards.json', 'cards (3).json', 'data/cards-gotham.json', '../cards (3).json'],
  ...
  packs: [
    ...
    { name:'Gold', kind:'composite', size:9, cost:0, cover:'img/Deck%20back%20oro%20BATMAN.webp', parts:[{count:3,scope:'mode',series:['Oggetto']},{count:6,scope:'mode',series:['Gold']}], description:'Contiene 9 carte: 3 oggetti e 6 carte della serie Gold.' },
    { name:'Silver', kind:'composite', size:9, cost:0, cover:'img/Deck%20back%20argento%20BATMAN.webp', parts:[{count:3,scope:'mode',series:['Oggetto']},{count:6,scope:'mode',series:['Silver']}], description:'Contiene 9 carte: 3 oggetti e 6 carte della serie Silver.' },
    { name:'Bronze', kind:'composite', size:9, cost:0, cover:'img/Deck%20back%20bronzo%20BATMAN.webp', parts:[{count:3,scope:'mode',series:['Oggetto']},{count:6,scope:'mode',series:['Bronze']}], description:'Contiene 9 carte: 3 oggetti e 6 carte della serie Bronze.' },
