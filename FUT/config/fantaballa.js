...
window.FUTTU_CONFIG = {
  ...
  packs: [
    { name:'Patatine', kind:'finite', size:1, cost:0, referenceCost:20000, referenceCurrency:'likes', scope:'mode', excludeSeries:['Leggendaria'], cover:'img/patatrine.webp', description:'Contiene 1 carta Fantaballa FC. Pacchetto veloce, semplice e immediato.' },
    ...
    { name:'Silver', kind:'composite', size:9, cost:0, referenceCost:400, referenceCurrency:'coins', cover:'img/Deck%20back%20argento.webp', parts:[{count:3,scope:'mode-or-shared',series:['Oggetto']},{count:6,scope:'mode',series:['Silver']}], description:'Contiene 9 carte: 3 oggetti e 6 carte della serie Silver.' },
    { name:'Bronze', kind:'composite', size:9, cost:0, referenceCost:100, referenceCurrency:'coins', cover:'img/Deck%20back%20bronzo.webp', parts:[{count:3,scope:'mode-or-shared',series:['Oggetto']},{count:6,scope:'mode',series:['Bronze']}], description:'Contiene 9 carte: 3 oggetti e 6 carte della serie Bronze.' },
